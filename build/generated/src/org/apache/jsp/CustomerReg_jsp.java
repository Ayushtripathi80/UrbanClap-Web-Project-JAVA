...
public final class CustomerReg_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<h1>REGISTRATION<span>Provide Your Information For Best Experience!!</span></h1>\n");
      out.write("<form action=\"./RegSubmit\" method=\"post\">\n");
      out.write("    <div class=\"section\"><span>:)</span>Customer Registration</div>\n");
      out.write("    <div class=\"inner-wrap\">\n");
      out.write("        <label>Name <input type=\"text\" name=\"t1\" placeholder=\"Enter Name\"/></label>\n");
      out.write("\n");
      out.write("        <label>Email <input type=\"text\" name=\"t2\" placeholder=\"Enter Email\"  pattern=\"[^ @]*@[^ @]*\"/></label>\n");
      out.write("        <label>Password <input type=\"password\" name=\"t3\" placeholder=\"Enter Password\"/></label>\n");
      out.write("        <label>Type <input type=\"text\" name=\"t4\" value=\"Customer\" placeholder=\"Customer\" readonly=\"readonly\"/></label>\n");
      out.write("          <label>Mobile <input type=\"text\" name=\"t5\" placeholder=\"Enter Mobile Number\" required pattern=\"[0-9]{10}\"/></label>\n");
      out.write("           <label>City <select name=\"t6\" required>\n");
      ...
      out.write("          <label>Address <textarea name=\"t7\" rows=\"3\" cols=\"20\">\n");
      out.write("              </textarea></label>\n");
      out.write("             <label>Photo <input type=\"file\" name=\"t8\" /></label>\n");
      out.write("        \n");
      out.write("    </div>\n");
      out.write("\n");
      out.write("\n");
      ...
      out.write("         <a href=\"login.jsp\">Already User??</a> \n");
      out.write("     </span>\n");
      out.write("    </div>\n");
      out.write("</form>\n");
      out.write("</div>\n");
